...
export const formSelector = {
  formSelector: profilePopupForm,
  inputSelector: inputName,
  submitButtonSelector: submitBtnSelector,
  inactiveButtonClass: inactBtnClass,
  inputErrorClass: inputErrClass,
  errorClass,
};
...
export const profileNameInput = profilePopupEdit.querySelector(
  ".popup__input_type_name"
);
export const profileAboutInput = profilePopupEdit.querySelector(
